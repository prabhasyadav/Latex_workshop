...
\author[\textcopyright  P. K. Yadav \& R. Sugumar]{\vspace{-0.3cm}\textbf{Session: Tables in \LaTeX}}
...
\begin{flushleft}
Presented by: \textbf{P. K. Yadav \& R. Sugumar} \\
...
\begin{textblock*}{500mm}(.77\textwidth,-0.9cm)
\includegraphics[height=0.8cm,width=3cm]{fig/logo}
\end{textblock*}}
